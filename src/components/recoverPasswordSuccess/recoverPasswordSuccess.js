...
import styles from "./recoverPasswordSuccess.module.css";
...
class recoverPasswordSuccessComponent extends Component {
  state = {};
  render() {
    return (
      <div>
                ...
                <Grid container>
                  <Grid item xs={12} sm={10}  md={6} lg={5} xl={5} className={styles.inputFields}>
                    ...
                    <div className={styles.registrationTitle}>
                      Your Password has been <br></br> Recovered Successfully!
                    </div>
...
export default withStyles(styles)(recoverPasswordSuccessComponent);
